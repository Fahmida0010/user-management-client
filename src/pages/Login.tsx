    ...
    <div className="container-fluid min-vh-100 p-0 bg-light">
      <div className="row g-0 min-vh-100 flex-column-reverse flex-lg-row">
        ...
        <div className="col-12 col-lg-6 d-flex flex-column justify-content-between p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5 bg-white">
          ...
          {/* Logo */}
          <div className="w-100 mx-auto style={{ maxWidth: '440px' }}" style={{ maxWidth: '440px' }}>
            <p className="small text-muted mb-1">This is a login form:</p>
          ...
          <div className="w-100 mx-auto my-auto py-4" style={{ maxWidth: '440px' }}>
            ...
            <form onSubmit={handleLogin} className="d-flex flex-column gap-3">
              ...
              <div className="form-check d-flex align-items-center gap-2 mt-1">
                <input type="checkbox" id="remember" className="form-check-input m-0 shadow-none" style={{ cursor: 'pointer' }} />
                <label htmlFor="remember" className="form-check-label small text-secondary select-none" style={{ cursor: 'pointer' }}>
                  Remember me
                </label>
              </div>
